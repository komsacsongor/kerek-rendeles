...
| **v2.51.0** | 2026-06-18 | **Recept↔termék ár/törlés szinkron**: `products.price` az egyetlen igazság-forrás (saveRecipe beolvassa az ár-mezőt, modal a linkelt termék árát tölti, meglévő ár megőrződik, dup-check linkelést ajánl, törlés feloldja a product_id-t névből) — *staging, ellenőrzés alatt* |
