...
let R = _s || {
  ...
  recipeCategories: ['Kenyér', 'Bagett / zsömle', 'Sütemény', 'Leveles tészta', 'Egyéb'],
  ...
  recipes: [
    {
      id:1, name:'Kovászos prémium kenyér', category:'Kenyér', basePortion:1000,
      bakeLoss:16, unitWeight:1000, temp1:230, time1:20, temp2:180, time2:70,
      desc:'Kovászos gluténmentes prémium kenyér – a pékség alaptermékei',
      levainAmount:260,
      dryIngredients:[
        {name:'Zabliszt', amount:110, ingredientId:8},
        {name:'Világos hajdina liszt', amount:130, ingredientId:11},
        {name:'Édesrizs liszt', amount:55, ingredientId:7},
        {name:'Tápióka liszt', amount:75, ingredientId:13},
        {name:'Psyllium / Útifű', amount:18, ingredientId:16},
        {name:'Só', amount:16, ingredientId:3},
      ],
      wetIngredients:[
        {name:'Víz', amount:410, ingredientId:1},
        {name:'Olívaolaj', amount:30, ingredientId:2},
        {name:'Ecet', amount:14, ingredientId:19},
      ],
      steps:[
        {title:'Áztatás', desc:'A psylliumot, a vizet és az ecetet összeöntjük, csomómentesre kavarjuk és felmelegítjük 40 fokra. 10 percet állni hagyjuk.', timer:10},
        {title:'Száraz összetevők', desc:'A száraz összetevőket kimérjük a dagasztó tálba és 2 percen keresztül összekeverjük amíg homogén nem lesz.', timer:2},
        {title:'Dagasztás', desc:'A dagasztó tálba a lisztekre ráöntjük a levaint, az olíva olajat és az áztatott psylliumot, majd 1-es fokozaton 10 percet dagasztjuk.', timer:10},
        {title:'Kelesztés', desc:'Kimérjük a sütni kívánt mennyiségeket és elhelyezzük a sütő tálakba. 2 óra kelesztés, vagy gyors: 30 perc 50°C-on. Kelesztés után bevágjuk és megnedvesítjük.', timer:120},
        {title:'Sütés 1. fázis', desc:'Előmelegített 230°C sütőbe vetjük. 10 perc után bőven megnedvesítjük a kenyerek tetejét.', timer:20},
        {title:'Sütés 2. fázis', desc:'180°C-on sütjük további 70 percet. 10 percenként megnedvesítjük.', timer:70},
        {title:'Szárítás', desc:'A kikapcsolt sütőben hagyjuk 3 órán keresztül a tálcából kivéve, majd papírba csomagoljuk.', timer:180},
      ],
      laborH:1, electricity:5,
    },
    {
      id:2, name:'Diabétesz kenyér', category:'Kenyér', basePortion:1000,
      bakeLoss:16, unitWeight:1000, temp1:230, time1:20, temp2:180, time2:70,
      desc:'Alacsony glikémiás indexű gluténmentes kenyér',
      levainAmount:320,
      dryIngredients:[
        {name:'Quinoa liszt', amount:100, ingredientId:null},
        {name:'Világos hajdina liszt', amount:130, ingredientId:11},
        {name:'Cirok liszt', amount:80, ingredientId:null},
        {name:'Tápióka liszt', amount:70, ingredientId:13},
        {name:'Psyllium / Útifű', amount:20, ingredientId:16},
        {name:'Só', amount:15, ingredientId:3},
        {name:'Chia/lenmag', amount:60, ingredientId:15},
      ],
      wetIngredients:[
        {name:'Víz', amount:350, ingredientId:1},
        {name:'Olívaolaj', amount:20, ingredientId:2},
        {name:'Ecet', amount:15, ingredientId:19},
      ],
      steps:[
        {title:'Áztatás', desc:'A psylliumot, a vizet és az ecetet összeöntjük, felmelegítjük 40 fokra. 10 percet állni hagyjuk.', timer:10},
        {title:'Száraz összetevők', desc:'Kimérjük és összekeverjük a száraz összetevőket 2 percig.', timer:2},
        {title:'Dagasztás', desc:'Hozzáadjuk a levaint, olíva olajat és áztatott psylliumot. 1-es fokozaton 10 perc.', timer:10},
        {title:'Kelesztés', desc:'500g sülthoz 590g nyers, 1000g sülthoz 1180g nyers tészta. 2 óra kelesztés.', timer:120},
        {title:'Sütés 1. fázis', desc:'230°C, 20 perc. Megnedvesítjük.', timer:20},
        {title:'Sütés 2. fázis', desc:'180°C, 70 perc.', timer:70},
        {title:'Szárítás', desc:'3 óra kikapcsolt sütőben.', timer:180},
      ],
      laborH:1, electricity:5,
    },
    {
      id:3, name:'Kovászos bagett', category:'Bagett / zsömle', basePortion:1000,
      bakeLoss:16, unitWeight:360, temp1:230, time1:20, temp2:180, time2:70,
      desc:'Ropogós héjú gluténmentes kovászos bagett',
      levainAmount:200,
      dryIngredients:[
        {name:'Zabliszt', amount:95, ingredientId:8},
        {name:'Világos hajdina liszt', amount:95, ingredientId:11},
        {name:'Tápióka liszt', amount:120, ingredientId:13},
        {name:'Csicseriborsó liszt', amount:65, ingredientId:null},
        {name:'Sushi rizs', amount:60, ingredientId:null},
        {name:'Psyllium / Útifű', amount:24, ingredientId:16},
        {name:'Só', amount:15, ingredientId:3},
        {name:'Cukor', amount:15, ingredientId:null},
        {name:'Száraz élesztő', amount:4, ingredientId:null},
      ],
      wetIngredients:[
        {name:'Víz', amount:430, ingredientId:1},
        {name:'Napraforgó olaj', amount:25, ingredientId:null},
        {name:'Ecet', amount:15, ingredientId:19},
      ],
      steps:[
        {title:'Áztatás', desc:'Psyllium + víz + ecet, 40 fokra melegítve, 10 perc állás.', timer:10},
        {title:'Száraz összetevők', desc:'Száraz összetevők homogenizálása 2 perc.', timer:2},
        {title:'Dagasztás', desc:'Levain + olaj + áztatott psyllium hozzáadása. 10 perc, 1-es fokozat.', timer:10},
        {title:'Kelesztés', desc:'Formázás, 2 óra kelesztés vagy gyors módszer.', timer:120},
        {title:'Sütés 1. fázis', desc:'230°C, 20 perc.', timer:20},
        {title:'Sütés 2. fázis', desc:'180°C, 70 perc.', timer:70},
        {title:'Szárítás', desc:'3 óra kikapcsolt sütőben.', timer:180},
      ],
      laborH:1, electricity:5,
