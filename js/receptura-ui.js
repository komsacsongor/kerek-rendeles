...
function nav(id) {
  ...
  const renders = {
    ...
    'gyartas-flow': () => { if(typeof renderGyartasFlow==='function') renderGyartasFlow(); }, 'op-select': () => { if(typeof renderGyartasTabbar==='function')renderGyartasTabbar('op-select'); renderOpSelect(); },
